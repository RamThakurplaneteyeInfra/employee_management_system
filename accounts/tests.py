...
class LeaveNotificationFlowTests(TestCase):
    ...
    def test_approval_all_sequential_first_show(self):
        ...
        self.assertIn(app_id, self._approval_ids_for(self.alt))
...
class PerformanceScoresListTests(TestCase):
    ...
    def test_classify_scoring_group_mutually_exclusive(self):
        ...
        self.assertEqual(classify_scoring_group({"P&S"}), "ps")
    ...
    def test_parse_scoring_group_aliases(self):
        ...
        self.assertEqual(parse_scoring_group("ps"), "ps")
        self.assertEqual(parse_scoring_group("p&s"), "ps")
