...
```
**notes:** `group_name` and `participants` (at least one username) required. Participants can be array or object with indices. Only **MD**, **TeamLead**, or **HR** may create groups. 201 on success; 403/406 on permission or invalid participants.
